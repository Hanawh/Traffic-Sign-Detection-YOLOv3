...
def evaluate(model, path, info, iou_thres, conf_thres, nms_thres, img_size, batch_size):
    model.eval()

    # Get dataloader
    dataset = ListDataset(path, info, img_size=img_size, augment=False, multiscale=False)
